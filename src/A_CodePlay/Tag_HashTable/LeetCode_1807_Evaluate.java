 ...
 */
public class LeetCode_1807_Evaluate {
    ...
    public String evaluate(String s, List<List<String>> knowledge) {
        ...
        for (int i = 0; i < len; i++) {
            if (s.charAt(i) == '(') {
                ...
                String str = s.substring(i + 1, right);
    ...
    public static void main(String[] args) {
        ...
        tmp2.add("two");
        knowledge.add(tmp2);
        System.out.println(new LeetCode_1807_Evaluate().evaluate("(name)is(age)yearsold", knowledge));
    }
}
