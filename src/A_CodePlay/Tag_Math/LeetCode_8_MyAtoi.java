...
public class LeetCode_8_MyAtoi {
    ...
    public static int myAtoi(String str) {
        ...
        for (int k = 0; k < num.length(); k++) {
            ...
            if (flag){
                if (ans < Integer.MIN_VALUE / 10|| ans == Integer.MIN_VALUE / 10 && cur > 8) return Integer.MIN_VALUE;
                ans = ans * 10 - cur;
            }
            else {
                if (ans > Integer.MAX_VALUE / 10 || ans == Integer.MAX_VALUE / 10 && cur > 7) return Integer.MAX_VALUE;
                ans = ans * 10 + cur;
            }
        }
        return ans;
