 ...
 * 解释: L = 50, V = 5, III = 3.
 */
public class LeetCode_IntToRoman {

    private static int[] arabianNumbers = new int[]{1000,900,500,400,100,90,50,40,10,9,5,4,1};
    private static String[] romanNumbers = new String[]{"M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"};
    ...
    public static String intToRoman(int target) {
        ...
        for (int i = 0; i < arabianNumbers.length; i++) {
            while (target >= arabianNumbers[i]){
                builder.append(romanNumbers[i]);
                target -= arabianNumbers[i];
            }
